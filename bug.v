...
(* File reduced by coq-bug-minimizer from original input, then from 225 lines to 158 lines, then from 174 lines to 158 lines, then from 173 lines to 158 lines, then from 172 lines to 1563 lines, then from 1570 lines to 158 lines, then from 172 lines to 2493 lines, then from 2499 lines to 2218 lines *)
(* coqc version 9.2+alpha compiled with OCaml 4.14.2
   coqtop version 9.2+alpha
   Expected coqc runtime on this file: 27.834 sec
   Expected coqc peak memory usage on this file: 1370928.0 kb *)
