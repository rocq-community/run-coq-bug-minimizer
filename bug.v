...
(* File reduced by coq-bug-minimizer from original input, then from 1186 lines to 28 lines, then from 42 lines to 568 lines, then from 575 lines to 37 lines, then from 51 lines to 614 lines, then from 620 lines to 656 lines, then from 660 lines to 656 lines, then from 660 lines to 656 lines, then from 660 lines to 656 lines *)
(* coqc version 9.4+alpha compiled with OCaml 4.14.2
   coqtop version 9.4+alpha
   Expected coqc runtime on this file: 1.424 sec
   Expected coqc peak memory usage on this file: 523108.0 kb *)
