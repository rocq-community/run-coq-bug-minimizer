...
Module Export Stdlib_DOT_ZArith_DOT_Znumtheory_WRAPPED.
Module Export Znumtheory.
...
Import Stdlib.ZArith.ZArith_base.
Import Stdlib.setoid_ring.ZArithRing.
Import Stdlib.ZArith.Zcomplements.
Import Stdlib.ZArith.Zdiv.
Import Stdlib.ZArith.Zdivisibility.
Import Stdlib.Arith.Wf_nat.
Import Stdlib.micromega.Lia.
Import Stdlib.setoid_ring.Cring.
Import Stdlib.setoid_ring.Ncring_tac.
...
Definition Zdivide_intro a b q (H:b=q*a) : Z.divide a b. exact (ex_intro _ q H). Defined.
...
Admitted.
Definition rel_prime (a b:Z) : Prop. exact (Zis_gcd a b 1). Defined.
...
End Stdlib_DOT_ZArith_DOT_Znumtheory_WRAPPED.
Module Export Stdlib_DOT_ZArith_DOT_Znumtheory.
Module Export Stdlib.
Module Export ZArith.
Module Export Znumtheory.
Include Stdlib_DOT_ZArith_DOT_Znumtheory_WRAPPED.Znumtheory.
End Znumtheory.
...
End Stdlib_DOT_ZArith_DOT_Znumtheory.
Export Stdlib.ZArith.BinInt.
Export Stdlib.ZArith.Zpower.
Module Export Coqlib.
Export Stdlib.Strings.String.
Export Stdlib.ZArith.Znumtheory.
