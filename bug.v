...
(* File reduced by coq-bug-minimizer from original input, then from 3505 lines to 2115 lines, then from 2114 lines to 1799 lines, then from 1800 lines to 1709 lines, then from 1710 lines to 1710 lines *)
(* coqc version 9.1+alpha compiled with OCaml 4.14.2
   ...
   Expected coqc runtime on this file: 61.194 sec *)
